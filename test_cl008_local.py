...
docx_path = r'C:\Users\jhamrick\Downloads\CL008 - Loss Mit Consult 44 Day - Commerce - V1.0 (1).docx'
...
print(f"Few-shot: {len(few_shot)} examples ({[e['name'] for e in few_shot]})")
...
out_path = os.path.join(BASE, 'cl008_output.html')
